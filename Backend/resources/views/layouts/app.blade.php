...
<head>
    ...
    <title>Control Parental App</title>
...
<body>
                    ...
                    <ul class="metismenu" id="menu1">
                        <li>
                            <a class="has-arrow" href="index.html">
								   ...
								   <span class="mini-click-non">Gestion Users</span>
								</a>
                        ...
                        <li>
                            <a class="has-arrow" href="mailbox.html" aria-expanded="false"><i class="fa big-icon fa-envelope icon-wrap"></i> <span class="mini-click-non">Chat</span></a>
                        ...
                        <li>
                            <a class="has-arrow" href="mailbox.html" aria-expanded="false"><i class="fa big-icon fa-bar-chart-o icon-wrap"></i> <span class="mini-click-non">Statistiques</span></a>
                            <ul class="submenu-angle" aria-expanded="false">
                                            ...
                                            <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                                ...
                                                <li class="nav-item">
                                                    <a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle">
															...
															<span class="admin-name">Warren T</span>
															<i class="fa fa-angle-down adminpro-icon adminpro-down-arrow"></i>
														</a>
                                                    <ul role="menu" class="dropdown-header-top author-log dropdown-menu animated zoomIn">
                                                        <li><a href="#"><span class="fa fa-user author-log-ic"></span>Profile</a>
                                                        </li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="footer-copy-right">
                            <p>Copyright   &copy 2021  <a href="#">UDS</a> All rights reserved.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script src="{{url('assets/js/sparkline/jquery.charts-sparkline.js')}}"></script>
    <!-- calendar JS
		============================================ -->
    <script src="{{url('assets/js/calendar/moment.min.js')}}"></script>
    <script src="{{url('assets/js/calendar/fullcalendar.min.js')}}"></script>
    <script src="{{url('assets/js/calendar/fullcalendar-active.js')}}"></script>
	<!-- float JS
		============================================ -->
    ...
    <script src="{{url('assets/js/flot/flot-active.js')}}"></script>
    <!-- plugins JS
		============================================ -->
