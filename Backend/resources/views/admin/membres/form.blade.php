...
<div class="form-group {{ $errors->has('prenom') ? 'has-error' : ''}}">
    ...
    {!! Form::textarea('prenom', null, ('' == 'required') ? ['class' => 'form-control', 'required' => 'required'] : ['class' => 'form-control']) !!}
...
<div class="form-group {{ $errors->has('ville') ? 'has-error' : ''}}">
    ...
    {!! Form::text('ville', null, ('' == 'required') ? ['class' => 'form-control', 'required' => 'required'] : ['class' => 'form-control']) !!}
...
<div class="form-group {{ $errors->has('confirmpassword') ? 'has-error' : ''}}">
    {!! Form::label('confirmpassword', 'Confirmpassword', ['class' => 'control-label']) !!}
    {!! Form::password('confirmpassword', ('' == 'required') ? ['class' => 'form-control', 'required' => 'required'] : ['class' => 'form-control']) !!}
