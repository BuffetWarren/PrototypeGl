...
class MessagesController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('directory.messages.index', compact('messages'));
    }
    ...
    {
        return view('directory.messages.create');
    }
    ...
    public function show($id)
    {
        ...
        return view('directory.messages.show', compact('message'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('directory.messages.edit', compact('message'));
    }
